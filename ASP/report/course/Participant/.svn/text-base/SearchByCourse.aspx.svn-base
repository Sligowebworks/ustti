<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchByCourse.aspx.cs" Inherits="reports_participants_SearchByCourse" %>
						...
						<tr>
                            ...
                            <td class="content_text" colspan="2" valign="top">                                
                                ...
                                <rsweb:ReportViewer ID="RPPartipants" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="800px" Width="100%">
                                    <LocalReport>
                                        <DataSources>
                                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="ParticipantByCourse_sp_ParticipantByCourse" />
                                        </DataSources>
                                    </LocalReport>
                                </rsweb:ReportViewer>
