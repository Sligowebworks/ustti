<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MultiBioSheet.aspx.cs" Inherits="report_multibiosheet_MultiBioSheet" %>
						...
						<tr>
                            ...
                            <td class="content_text" colspan="2" valign="top">   
                                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="800px" Width="100%">
                                    <LocalReport ReportPath="C:\USTTI\templates\multibiosheet\MultiBioSheet.rdlc">
                                        <DataSources>
                                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="MultiBioSheet_sp_MultiBioSheet" />
                                        </DataSources>
                                    </LocalReport>
                                </rsweb:ReportViewer>
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData"
                                    TypeName="MultiBioSheetTableAdapters.sp_MultiBioSheetTableAdapter"></asp:ObjectDataSource>
