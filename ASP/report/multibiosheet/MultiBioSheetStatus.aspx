<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MultiBioSheetStatus.aspx.cs" Inherits="report_multibiosheet_MultiBioSheet2" %>
						...
						<tr>
                            ...
                            <td class="content_text" colspan="2" valign="top"> 
                                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="800px" Width="100%">
                                    <LocalReport ReportPath="C:\USTTI\templates\multibiosheet\MultiBioSheetStatus.rdlc">
                                        <DataSources>
                                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="MultiBioSheetStatus_sp_MultiBioSheetStatus"></rsweb:ReportDataSource>
                                        </DataSources>
                                    </LocalReport>
                                </rsweb:ReportViewer>
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData"
                                    TypeName="MultiBioSheetStatusTableAdapters.sp_MultiBioSheetStatusTableAdapter"></asp:ObjectDataSource>                                                                                                                
