<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BioSheet.aspx.cs" Inherits="reports_biosheet_BioInfoSheet" %>
						...
						<tr>
                            ...
                            <td class="content_text" colspan="2" valign="top">                                
                                ...
                                <rsweb:ReportViewer ID="RPBioSheet" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="800px" Width="100%">
                                    <LocalReport ReportPath="C:\USTTI\templates\biosheet\BioSheet.rdlc">
                                        <DataSources>
                                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="BioSheet_StudentSheet" />
                                        </DataSources>
                                    </LocalReport>
                                </rsweb:ReportViewer>
