<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BioSheetDetail.aspx.cs" Inherits="report_biosheet_BioSheetDetail" %>
					...
					<table class="expand"  cellspacing="0" cellpadding="0">
						<tr>
                            ...
                            <td class="content_text" colspan="2" valign="top">   
                                <rsweb:ReportViewer ID="RPBioSheet" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="800px" Width="100%">
                                    <LocalReport ReportPath="C:\USTTI\templates\biosheet\BioSheetDetail.rdlc">
                                        <DataSources>
                                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="BioSheet_sp_StudentSheet" />
                                        </DataSources>
                                    </LocalReport>
                                </rsweb:ReportViewer>
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData"
                                    TypeName="BioSheetTableAdapters.sp_StudentSheetTableAdapter"></asp:ObjectDataSource>
