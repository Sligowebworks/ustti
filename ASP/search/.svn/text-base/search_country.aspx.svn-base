<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search_country.aspx.cs" Inherits="search_search_country" %>
                                ...
                                <asp:DataGrid id="QueueGrid" runat="server" AlternatingItemStyle-BackColor="#EFEFEF" 
					                ...
					                <Columns>		
					                    ...
					                    <asp:TemplateColumn HeaderText="View Report">
				                            <ItemTemplate>
					                            <a href='../report/course/participant/SearchByCountry.aspx?CountryID=<%# Server.UrlEncode( DataBinder.Eval(Container.DataItem, "CountryID" ).ToString() )%>&Year=<%# Server.UrlEncode( DataBinder.Eval(Container.DataItem, "Year" ).ToString() )%>'>Participant Report <br/>By Country</a>
				                            </ItemTemplate>
			                            </asp:TemplateColumn>
					                
					                    <asp:TemplateColumn HeaderStyle-Font-Bold="True" HeaderText="Country Name" SortExpression="Country" >
						                    <ItemTemplate>
						                        <asp:LinkButton ID="lbCountryName" OnCommand="Country_Click" runat="server" CommandName="CountryCommand" Text='<%# DataBinder.Eval(Container.DataItem, "Country") %>' />						                            						                        
						                    </ItemTemplate>
						                </asp:TemplateColumn>
