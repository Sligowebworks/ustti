<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search_student_info.aspx.cs" Inherits="search_search_student_info" %>
							...
							<USTTI:menu ID="menu" runat="server" />
                                ...
                                <asp:DataGrid id="QueueGrid" runat="server" AlternatingItemStyle-BackColor="#EFEFEF" 
					                ...
					                <Columns>		
						                ...
						                <asp:BoundColumn DataField="Email" HeaderText="Work Email" HeaderStyle-Font-Bold="True" SortExpression="Email" />
