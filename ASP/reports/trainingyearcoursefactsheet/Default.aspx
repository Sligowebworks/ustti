<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/reports/trainingyearcoursefactsheet/Default.aspx.cs" Inherits="trainingcoursefactsheet_report_default" %>
...
<HTML>
	<HEAD id="HEAD1" runat=server>
		<title>USTTI Training Course Fact Sheet Report</title>
		...
		<table class="expand" cellspacing="0" cellpadding=0>
			...
			<tr>
				<td class="header_border_top" >
					<table class="expand"  cellspacing="0" cellpadding=0>
                        <tr>
                            <td align="center" class="top_bar_left">&nbsp
                                </td>
						...
						<tr>
							...
							<td class="content_text" valign=top>							    
                                <div class="page_title">Training Course Fact Sheet Report Generator
                                    </div>
