<%@ Page Language="C#" AutoEventWireup="true" CodeFile="country_add_record.aspx.cs" Inherits="country_add_record" %>
					...
					<table class="expand"  cellspacing="0" cellpadding=0>
						...
						<tr>
							...
							<td class="content_text" valign=top>
                                ...
                                <div class="page_title">Country Information</div>
...
colSpan=2><asp:TextBox id="txtCountryName" runat="server" Width="150px" Font-Size="11px" Font-Names="Trebuchet MS" MaxLength="40"></asp:TextBox> 
...
vAlign=middle>
    Printable Name</TD><TD  colSpan=2>
        <asp:TextBox ID="txtPrintName" runat="server" Font-Names="Trebuchet MS"
            Font-Size="11px" Width="150px" MaxLength="40"></asp:TextBox></TD></TR><TR><TD style="WIDTH: 100px" vAlign=top>
    Abbreviation</TD><TD colSpan=2>
        <asp:TextBox ID="txtAbbr" runat="server" Font-Names="Trebuchet MS"
            Font-Size="11px" Width="40px" MaxLength="3"></asp:TextBox></TD></TR><TR><TD style="WIDTH: 100px; height: 26px;" vAlign=middle>
                                                            Mail Code</TD><TD colSpan=2 style="height: 26px">
                                                                <asp:TextBox ID="txtMailCode" runat="server" Font-Names="Trebuchet MS"
                                                                    Font-Size="11px" Width="100px" MaxLength="20"></asp:TextBox></TD></TR><TR><TD style="WIDTH: 100px" vAlign=middle>
...
style="HEIGHT: 22px" vAlign=top align=left colSpan=2><asp:DropDownList id="RegionList" runat="server" Font-Size="11px" Font-Names="Trebuchet MS" >
                                                        </asp:DropDownList>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="RegionList"
                                                                    Display="Dynamic" ErrorMessage="required" InitialValue="-Select Region-" SetFocusOnError="True"></asp:RequiredFieldValidator></TD></TR></TBODY></TABLE>
                                ...
                                <asp:SqlDataSource ID="RegionDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:usttiConnectionString %>"
                                    SelectCommand="SELECT regionname,regionid FROM [region]"></asp:SqlDataSource>
                            </td>
						</tr>
                        <tr>
