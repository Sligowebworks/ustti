<%@ Page Language="C#" AutoEventWireup="true" CodeFile="student_funding_record.aspx.cs" Inherits="student_funding_record" %>
							...
							<USTTI:menu ID="menu" runat="server" />
                                ...
                                <TBODY><TR><TD class="entry_form_header" vAlign=top colSpan=3>
                                    ...
                                    <tr>
                                        ...
                                        <USTTI:student_info_header ID="student_info_header" runat=server /> 
...
colSpan=2>
                                                        <asp:TextBox ID="txtAmount" runat="server" Font-Names="Trebuchet MS" Font-Size="11px" MaxLength="10"></asp:TextBox><asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtAmount"
    ...
    <TR><TD style="HEIGHT: 25px" colSpan=3>
                                            ...
                                            <asp:Label ID="lblDupMessage" runat="server" Font-Bold="True" Text="The Funder You Entered Already in The List"
                                                Visible="False"></asp:Label>
                                                                ...
                                                                <asp:Label ID="lblNullMessage3" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
                                                                    Font-Size="11px" Text="" Visible="False"></asp:Label>
                                            ...
                                            <asp:GridView ID="dgFunding" runat="server" AllowPaging="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="applicdate" HeaderText="App Date" DataFormatString="{0:d}" HtmlEncode="False" />
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td style="width: 3px; height: 26px">
                                                    <asp:Button ID="btnFinalize" runat="server" Font-Names="Trebuchet MS" Font-Size="11px"
                                                        OnClick="btnFinalize_Click" Text="Finalize" /></td>
                                            </tr>
                                        </table>
                                    </TD></TR></TBODY></TABLE>
                                </div>
                                ...
                                <asp:SqlDataSource ID="FunderDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:usttiConnectionString %>"
                                    SelectCommand="SELECT * FROM [funders] ORDER BY [fundername]"></asp:SqlDataSource>
