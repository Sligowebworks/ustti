<%@ Page Language="C#" AutoEventWireup="true" CodeFile="courseload_student_record.aspx.cs" Inherits="courseload_student_record" %>
...
<HTML>
	<HEAD id="HEAD1" runat=server>
		<title>USTTI Student's Course Load Information</title>
						...
						<tr>
							...
							<td class="content_text" valign=top>
                                ...
                                <TBODY><TR><TD class="entry_form_header" vAlign=top colSpan=3>
                                            ...
                                            <table id="tblEntryForm" runat="server" class="entry_form_detail" width="90%">
                                                <tr>
                                                    ...
                                                    <td colspan="2" style="height: 27px">
                                                        ...
                                                        <asp:TextBox ID="txtSID" runat="server" Visible="False"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 100px; height: 27px">
                                                        Country</td>
                                                ...
                                                <tr>
                                                    <td style="width: 100px; height: 27px">
                                                        Application Date</td>
                                                    <td colspan="2" style="height: 27px">
                                                <asp:TextBox id="txtAppDate" runat="server" Width="55px" ReadOnly="True" Font-Size="11px" Font-Names="Trebuchet MS"></asp:TextBox>
                                                <asp:TextBox id="txtAID" runat="server" Visible=false Width="60px" ReadOnly="True" Font-Size="11px" Font-Names="Trebuchet MS"></asp:TextBox></td>
                                                </tr>
                                            </table>
                                    ...
                                    <TR><TD style="HEIGHT: 29px" colSpan=3></TD></TR></TBODY>
                                    </TABLE>
                                </div>
                                &nbsp;&nbsp;
