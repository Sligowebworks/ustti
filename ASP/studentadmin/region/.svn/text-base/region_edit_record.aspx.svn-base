<%@ Page Language="C#" AutoEventWireup="true" CodeFile="region_edit_record.aspx.cs" Inherits="region_edit_record" %>
                                        ...
                                        <td colspan="3" valign="middle">
                                            ...
                                            <td style="width: 100px" valign="middle">
                                                Region ABBR <span style="color: #ff0033">*</span></td>
                                                    <td colspan="2">
                                                        <asp:TextBox ID="txtABBR" runat="server" Width="30px" Font-Names="Trebuchet MS" Font-Size="11px"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <asp:TextBox ID="txtRegionName" runat="server" Font-Names="Trebuchet MS" Font-Size="11px"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td valign="top" >
                                                <asp:Button ID="btnSubmit" runat="server" Font-Names="Trebuchet MS" Font-Size="11px"
                                                    OnClick="btnSubmit_Click1" Text="Save" /></td>
                                        </tr>
                                    </table>
