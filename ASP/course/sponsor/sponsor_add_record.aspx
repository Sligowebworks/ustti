<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sponsor_add_record.aspx.cs" Inherits="sponsor_add_record" %>
                                    ...
                                    <table  class="data_entry_form">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="height: 26px" valign="top">
                                                <asp:TextBox ID="txtSponsorName" runat="server" Width="134px" MaxLength="60" Font-Names="Trebuchet MS" Font-Size="11px"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" valign="top">
                                                <asp:TextBox ID="txtAbbr" runat="server" Width="60px" MaxLength="12" Font-Names="Trebuchet MS" Font-Size="11px"></asp:TextBox></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="height: 26px" valign="top">
                                                <asp:TextBox ID="txtState" runat="server" Width="134px" MaxLength="60" Font-Names="Trebuchet MS" Font-Size="11px"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="height: 18px" valign="top">
                                                <asp:TextBox ID="txtPhoneNbr1" runat="server" Width="134px" MaxLength="20" Font-Names="Trebuchet MS" Font-Size="11px"></asp:TextBox>
