<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sponsor_data.aspx.cs" Inherits="sponsor_data" %>
					...
					<table class="expand"  cellspacing="0"  cellpadding=0>
						...
						<tr>
							...
							<td class="content_text" valign=top style="height: 480px">							  
                                ...
                                <asp:GridView ID="dgSponsor" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <asp:SqlDataSource ID="SponsorDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:usttiConnectionString %>"
                                    SelectCommand="SELECT * FROM [sponsors] ORDER BY sponsid DESC"
                                    DeleteCommand="DELETE sponsors WHERE sponsid=@sponsid" >
                                </asp:SqlDataSource>
                            </td>
						</tr>
                        <tr>
