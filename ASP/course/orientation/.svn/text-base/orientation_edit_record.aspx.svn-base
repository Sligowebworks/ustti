<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orientation_edit_record.aspx.cs" Inherits="orientation_edit_record" %>
		...
		<table class="expand" cellspacing="0" cellpadding=0>
			...
			<tr>
				<td class="header_border_top" >
					<table class="expand"  cellspacing="0" cellpadding=0>
                        <tr>
                            <td align="center" height="20px" class="top_bar_left"  width="176" >&nbsp;</td>
                                    ...
                                    <table  class="data_entry_form">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="height: 26px" valign="top">
                                                ...
                                                </asp:DropDownList><asp:RequiredFieldValidator ID="OrientYearValidator" runat="server" ControlToValidate="OrientationYearList"
                                        ...
                                        <tr style="color: #000000">
                                            <td style="width: 75px; height: 28px" valign="middle">
                                                To</td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" valign="top" >
                                                &nbsp;<asp:TextBox ID="txtRange" runat="server" MaxLength="40" Width="135px" Font-Names="Trebuchet MS" Font-Size="11px"></asp:TextBox></td>
                                        </tr>
                                        <tr>
