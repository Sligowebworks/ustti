<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fundertype_search_record.aspx.cs" Inherits="fundertype_search_record" %>
					...
					<table class="expand"  cellspacing="0" cellpadding=0>
						...
						<tr>
							...
							<USTTI:menu ID="menu" runat="server" />
                                ...
                                <asp:TextBox id="txtFunderTypDes" runat="server" Font-Size="11px" Font-Names="Trebuchet MS" MaxLength="60" Width="200px"></asp:TextBox></TD></TR><TR><TD colSpan=3>
                                ...
                                <asp:Label ID="Label1" Visible=false Font-Bold=true runat="server" Text="Label"></asp:Label>
                                    ...
                                    <asp:GridView ID="dgFunderTyp" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="DarkGray" BorderStyle="Double"
