<%@ Page Language="C#" AutoEventWireup="true" CodeFile="funder_student_view.aspx.cs" Inherits="funder_student_view" %>
					...
					<table class="expand"  cellspacing="0" cellpadding=0>
						...
						<tr>
							...
							<td class="content_text" valign=top>
                                ...
                                <div class="gridview">
                                <asp:Label ID="lblMessNull" runat="server" Text="Label"></asp:Label>
                                <asp:GridView ID="dgStudent" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    DataKeyNames="studentid" DataSourceID="FunderStudentDataSource" Font-Names="trebuchet ms"
                                    Font-Size="11px">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="amount" HeaderText="Amount" HtmlEncode=False DataFormatString="{0:c}" />
                                    </Columns>
                                    <PagerStyle BackColor="#CAD3DC" Font-Names="trebuchet ms" Font-Size="11px" />
                                    <PagerSettings Mode="NumericFirstLast" />
                                </asp:GridView>
                                 </div>
                                <asp:SqlDataSource ID="FunderStudentDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:usttiConnectionString %>">
                                </asp:SqlDataSource>
