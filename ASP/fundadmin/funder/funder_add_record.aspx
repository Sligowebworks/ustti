<%@ Page Language="C#" AutoEventWireup="true" CodeFile="funder_add_record.aspx.cs" Inherits="funder_add_record" %>
...
colSpan=3>
                                        ...
                                        <td colspan="3" valign="middle">
                                            <table width="90%" class="entry_form_detail">
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <asp:DropDownList id="FunderTypeList" runat="server" Font-Size="11px" Font-Names="Trebuchet MS" DataSourceID="FunderTypeDataSource" DataTextField="fundertypdes" DataValueField="fundertypid" Width="135px">
                        ...
                        Display="Dynamic" ErrorMessage="required" SetFocusOnError="True" InitialValue="-Select Funder Type-"></asp:RequiredFieldValidator></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <asp:TextBox id="txtFunderName" runat="server" Font-Size="11px" Font-Names="Trebuchet MS" Width="135px" MaxLength="60"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="required" ControlToValidate="txtFunderName" Display="Dynamic"></asp:RequiredFieldValidator></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
